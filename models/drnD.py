"""
#
# This file contains our implementation of the DRN-D model.
#  
"""
...
class DRN_D(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        pretrained = False
        if pretrained:
            pretrained_dict = torch.load('models/pretrained/drn-d-105_ms_cityscapes.tar', 'cuda')
...
def test():
    ...
    model = DRN_D(in_channels=3, out_channels=1)
    preds = model(x)
